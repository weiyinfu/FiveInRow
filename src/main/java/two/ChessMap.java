...
public void init() {
    ...
    map = new ImageIcon(getClass().getResource("res/bg.jpg"));
    blackchess = new ImageIcon(getClass().getResource("res/blackchess.gif"));
    whitechess = new ImageIcon(getClass().getResource("res/whitechess.gif"));
